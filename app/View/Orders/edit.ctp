                    ...
                    if ($this->data['Order']['status'] != 'canceled') {
                        ...
                        if ($this->data['Order']['status'] != 'approved') {
                            echo $this->Html->link(
                                ...
                                array(
                                    'confirm' => 'Tem certeza que deseja APROVAR este pedido?',
                                    'title' => 'Aprovar',
                                    'class' => 'btn btn-success text-white mx-1 pull-right',
                                    'escape' => false
                                )
                            );
                        }

                        //Se não está recusado:
                        if ($this->data['Order']['status'] != 'rejected') {
                            echo $this->Html->link(
                                '<i class="fas fa-ban"></i> Recusar',
                                '#',
                                array(
                                    'title' => 'Recusar',
                                    'class' => 'btn btn-warning text-white mx-1 pull-right',
                                    'escape' => false,
                                    'data-toggle' => 'modal',
                        ...
                        //Se não está cancelado:
                        if ($this->data['Order']['status'] != 'canceled') {
                            //Se tem link da fatura
                            if (!empty($this->data['Order']['invoice_id'])) {
                                echo $this->Html->link(
                                    ...
                                    array(
                                        ...
                                        'class' => 'btn btn-danger text-white mx-1 pull-right',
                                        'escape' => false
                                    )
                                );
                            }
                        ...
                        if ($this->data['Order']['status'] != 'pending') {
                            echo $this->Html->link(
                                '<i class="fas fa-undo"></i> Voltar para Pendente',
                                array(
                                    'controller' => 'Orders',
                                    'action' => 'pending',
                                    $this->data['Order']['id']
                                ...
                                array(
                                    'confirm' => 'Tem certeza que deseja voltar este pedido para a situação PENDENTE?',
                                    'title' => 'Voltar para Pendente',
                                    'class' => 'btn btn-secondary text-white mx-1 pull-right',
                                    'escape' => false
                                )
                            );
                        }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="disapproveModalLabel"><i class="fas fa-ban"></i> Recusar Pedido</h5>
