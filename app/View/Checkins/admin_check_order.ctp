        ...
        <div class="col-lg-12 text-center">
            ...
            <div id="dataResult">
                ...
                if ($bloqueiaCheckinAdiantado) {
                    ...
                    $reason = 'Passaporte agendado somente para <strong>' . date('d/m/Y', strtotime($modalidade_data)) . '</strong>';
                }
                //Se está atrasado
                if ($bloqueiaCheckinAtrasado) {
                    $icon = '<i class="fas fa-exclamation text-danger"></i>';
                    $title = 'Passaporte Vencido!';
                    $reason = 'Passaporte vencido em <strong>' . date('d/m/Y', strtotime($modalidade_data)) . '</strong>';
                }
                //Se já foi feito
                if ($checkinExists) {
                ...
                <div class="checkin-church">Número: <?php echo $this->data['Order']['id']; ?></div>
                <div class="checkin-church">Data: <?php echo $this->Alv->tratarData($modalidade_data, 'pt'); ?></div>
                <?php
